# Archolith Skree — Codex Plugin

Live MCP token usage audit (Archolith Skree) for Codex sessions. Tracks per-server token spend and waste patterns in real time.
